  ...
  <header className="header">
    <div className="header-main">
      ...
      <div className="header-actions">
        <nav className="header-nav" aria-label="Outils Ascend">
          <button
            type="button"
            ...
            data-tooltip={sidebarCollapsed ? 'Afficher les options' : 'Masquer les options'}
          >
          ...
          <button
            ...
            data-tooltip={
              metricsFailureCount > 0
                ? `Paramètres · ${metricsFailureCount} échec${metricsFailureCount > 1 ? 's' : ''} conversion`
                : 'Paramètres'
            }
