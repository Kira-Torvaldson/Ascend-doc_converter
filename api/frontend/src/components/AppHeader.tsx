/**
 * En-tête Ascend : marque, statut, Convertir, historique, paramètres.
 */
...
interface AppHeaderProps {
  ...
  sourceFormatTitle: string;
  targetFormatTitle: string;
      ...
      <div className="header-actions">
        <div className="header-convert-group">
          <span className="header-format-chip" aria-hidden="true">
            <span className="header-format-chip-from">{sourceFormatTitle}</span>
            <span className="header-format-chip-arrow">→</span>
            <span className="header-format-chip-to">{targetFormatTitle}</span>
          </span>
          <button
            type="button"
              ...
              sourceFormat === targetFormat
                ...
                : isEditingResult
                  ...
                  : !sourceHasContent
                    ...
                    : `${sourceFormatTitle} → ${targetFormatTitle}`
            }
          >
            {loading ? (
        ...
        <button
          type="button"
          className="settings-button header-icon-btn header-history-btn"
