/**
 * En-tête Ascend : marque + navbar d’outils.
 */
...
export const AppHeader: React.FC<AppHeaderProps> = ({
  ...
  const t = useT();
  const sidebarLabel = sidebarCollapsed ? t('header.sidebar.show') : t('header.sidebar.hide');
  const settingsLabel =
    metricsFailureCount > 0
      ? t('header.settings.failures', { count: metricsFailureCount })
      : t('header.settings');
  const settingsAria =
    metricsFailureCount > 0
  ...
  <header className="header">
    <div className="header-main">
      ...
      <div className="header-actions">
        <nav className="header-nav" aria-label={t('header.nav')}>
          <button
            type="button"
          ...
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
              ...
              {!sidebarCollapsed && (
                <path d="M18 8L14 12L18 16" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
              )}
            </svg>
          </button>
          ...
          <ShortcutsHelpPopover
            ...
            onToggle={onToggleShortcutsHelp}
