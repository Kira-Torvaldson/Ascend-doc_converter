...
async function main() {
  ...
  try {
    ...
    console.log('[OK] e2e /api/text-to-markdown failure returns standardized ConversionResult with structured error.code')
  } finally {
...
main()
  ...
  .catch((err) => {
    console.error('[FAIL] e2e text-to-markdown failure-flow contract verification failed')
