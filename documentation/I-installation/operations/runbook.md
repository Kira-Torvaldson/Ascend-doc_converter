...
**Version documentée :** `0.0.1.5` (backend / frontend alignés via `npm run check:version`).
...
npm run check:docker:backend  # build image backend + pandoc (identique CI job docker)
# ou détaillé :
npm run check:version
...
Matrice complète : [`configuration.md`](../configuration.md#production-limits-matrix-ascend-00147).
...
- Axes d’amélioration : [`axes-ameliorations-0.0.1.5.md`](../../V-specifications/axes-ameliorations-0.0.1.5.md)
- Roadmap : [`roadmap.md`](../../V-specifications/roadmap.md)
